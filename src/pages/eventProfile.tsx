...
export default function EventProfile() {
  ...
  const [symptomsList, setSymptomsList] = useState(['Apertado', 'Ardente', 'Pesado']);
        ...
        <div className="lg:col-span-4 flex flex-col gap-8">
          <div>
            ...
            <p className="text-[18px] text-[#E4007C] font-normal leading-relaxed">
              Documente com precisão os detalhes dos seus eventos de saúde recentes para o seu médico.
            </p>
          </div>
        ...
        <div className="lg:col-span-8 bg-white rounded-[32px] p-8 shadow-sm border border-[#F4E6EE]">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
              <img src="/imgs/eventProfile/peopleIcon.svg" alt="Icon" className="w-6 h-6" />
              <h2 className="text-[20px] font-bold text-[#2D2D2D]">Toque no local da dor</h2>
            </div>
            <button className="text-[14px] font-bold text-[#E4007C] hover:underline">Redefinir Mapa</button>
          </div>

          <BodyMap />

          <div className="mb-8">
            <label className="block text-[16px] font-bold text-[#2D2D2D] mb-3">Onde você sentiu dor?</label>
            <div className="relative">
              <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
                <img src="/imgs/eventProfile/locationIcon.svg" alt="Location" className="w-5 h-5 opacity-60" />
              </div>
              <input 
                type="text" 
          ...
          <div className="mb-12">
            <label className="flex items-center gap-2 text-[16px] font-bold text-[#2D2D2D] mb-3">
              <img src="/imgs/eventProfile/heartIcon.svg" alt="Heart" className="w-5 h-5" />
